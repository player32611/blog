...
// node_modules/sakana-widget/lib/index.esm.js
var resizeObservers = [];
...
var _SakanaWidget = class _SakanaWidget {
  constructor(options = {}) {
    __publicField(this, "_options");
    // app metadata
    __publicField(this, "_imageSize");
    __publicField(this, "_canvasSize");
    __publicField(this, "_limit");
    __publicField(this, "_lastRunUnix", Date.now());
    __publicField(this, "_frameUnix", 1e3 / 60);
    // default to speed of 60 fps
    __publicField(this, "_running", true);
    __publicField(this, "_magicForceTimeout", 0);
    __publicField(this, "_magicForceEnabled", false);
    // character related
    __publicField(this, "_char");
    __publicField(this, "_image");
    __publicField(this, "_state");
    // dom element related
    __publicField(this, "_domWrapper");
    // this is needed for resize observer
    __publicField(this, "_domApp");
    // actual app element
    __publicField(this, "_domCanvas");
    __publicField(this, "_domCanvasCtx");
    __publicField(this, "_domMain");
    __publicField(this, "_domImage");
    __publicField(this, "_domCtrlPerson");
    __publicField(this, "_domCtrlMagic");
    __publicField(this, "_domCtrlClose");
    __publicField(this, "_resizeObserver", null);
    /**
     * @private
     * calculate limit and update from size
     */
    __publicField(this, "_updateLimit", (size2) => {
      let maxR = size2 / 5;
      if (maxR < 30) {
        maxR = 30;
      } else if (maxR > 60) {
     ...
     * refresh widget size
     */
    __publicField(this, "_updateSize", (size2) => {
    ...
    __publicField(this, "_updateDom", () => {
      ...
      img2.className = "sakana-widget-img";
      img2.style.backgroundImage = `url('${this._image}')`;
      this._domImage = img2;
     ...
     */
    __publicField(this, "_calcCenterPoint", (degree, radius, x, y) => {
    ...
    __publicField(this, "_draw", () => {
      ...
      const img2 = this._domImage;
      const imgSize = this._imageSize;
      const ctx = this._domCanvasCtx;
      const x = r * 1;
      img2.style.transform = `rotate(${r}deg) translateX(${x}px) translateY(${y}px)`;
     ...
     */
    __publicField(this, "_onTouchStart", (e) => {
      e.preventDefault();
      this._running = false;
      if (!e.touches[0]) {
        return;
     ...
     */
    __publicField(this, "_magicForce", () => {
      if (Math.random() < 0.1) {
     ...
     */
    __publicField(this, "triggerAutoMode", () => {
     ...
     */
    __publicField(this, "setCharacter", (name) => {
     ...
     */
    __publicField(this, "nextCharacter", () => {
     ...
     */
    __publicField(this, "_onResize", (rect) => {
 ...
 */
__publicField(_SakanaWidget, "getCharacter", (name) => {
  if (_characters == null) {
    _initCharacters();
  }
 ...
 */
__publicField(_SakanaWidget, "getCharacters", () => {
  if (_characters == null) {
    _initCharacters();
  }
 ...
 */
__publicField(_SakanaWidget, "registerCharacter", (name, character) => {
...
sakana-widget/lib/index.esm.js:
  (*! sakana-widget | DSRKafuU (https://dsrkafuu.net) | Copyright (c) MIT License *)
*/
//# sourceMappingURL=sakana-widget.js.map
