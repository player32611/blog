	...
	themeConfig: {
		...
		sidebar: [
			...
			},
			{
				...
				items: [{ text: "常用函数", link: "/pages/gms2/common-functions" }],
			},
			{
				text: "算法",
				items: [
	...
	vite: {
		resolve: {
			alias: [
				{
					find: /^.*\/VPButton\.vue$/,
					replacement: fileURLToPath(new URL("./theme/components/Button.vue", import.meta.url)),
				},
				{
					find: /^.*\/VPSwitch\.vue$/,
				...
				{
					find: /^.*\/VPFeature\.vue$/,
					replacement: fileURLToPath(new URL("./theme/components/Card.vue", import.meta.url)),
				},
				{
					find: /^.*\/VPLink\.vue$/,
					replacement: fileURLToPath(new URL("./theme/components/VPLink.vue", import.meta.url)),
				},
			],
		},
	},
